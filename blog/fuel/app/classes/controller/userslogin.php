...
class Controller_Userslogin extends Controller_Template
{
...
{
$auth = Auth::instance();
$view = View::forge('userslogin/register');
...
$this->template->title = 'Userslogin &raquo; Register';
$this->template->content = $view;
}

public function action_login()
{
    $view = View::forge('userslogin/login');
